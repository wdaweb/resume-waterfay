...
<body>
            ...
            <?php 
                        $bt=$Bottom->find(1);
                    ?>
            <div class="col col-2" style="border:0.5px solid white"><textarea name="bottom" style="width:100px;height:200px;"><?=$b0t['bottom'];?></textarea></div>
            <div class="col col-3" style="border:0.5px solid white"><img src='../img/<?=$sf['img'];?>' style="width:100px;height:200px"></div>
            <div class="col col-3 py-3" style="text-align:center"><textarea name="bottom" style="width:150px;height:200px;"><?=$bt['bottom'];?></textarea></div>
